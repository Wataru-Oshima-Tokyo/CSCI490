...
SET_EMAIL='wataruoshima@my.smccd.edu'
SET_PASSWORD='Ichiro0705'
SET_MFA_SECRET=''
# something like:
...
# browser identity
SET_BROWSER='Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/13.0.5 Safari/605.1.15 bash-script/1.0'
